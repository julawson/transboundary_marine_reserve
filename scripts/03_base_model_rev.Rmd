...
colnames(results_matrix_soa) <- c("timestep", "x_a_init", "x_a", "e_a_star", "h_a_val", "x_b_init", "x_b", "h_b_val", "NPV_ea_star", "NPV_eb_star")
...
for(i in seq_along(x_a_grid)) {
  for(j in seq_along(x_b_grid)) {
    ...
    for(t in 0:timesteps) {
      ...
      # Save results
      results_matrix_soa[row_counter, ] <- c(t, x_a_init, x_a, e_a_star, h_a_val, x_b_init, x_b, h_b_val, NPV_ea_star, NPV_eb_star)
      row_counter <- row_counter + 1
    }
