...
colnames(results_matrix_soa) <- c("M_ba", "timestep", "x_a_init", "x_a", "h_a_val", "e_a_star", "x_b_init", "x_b", "h_b_val", "NPV_ea_star")
  ...
  for(j in seq_along(x_b_grid)) {
    ...
    for(M_ba in seq(0, 1, by = 0.1)) {
      ...
      for(t in 0:timesteps) {
        ...
        # Save results
        results_matrix_soa[row_counter, ] <- c(M_ba, t, x_a_init, x_a, h_a_val, e_a_star, x_b_init, x_b, h_b_val, NPV_ea_star)
        row_counter <- row_counter + 1
      }
...
write.csv(results, here("data","outputs","low_high","theta_Mba_rev.csv"), row.names=FALSE)
