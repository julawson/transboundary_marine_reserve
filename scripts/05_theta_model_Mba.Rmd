...
colnames(results_matrix_non) <- c("M_ba", "timestep", "x_a_init", "x_a", "e_hat_a", "x_b_init", "x_b", "e_hat_b", "NPV_a_hat", "NPV_b_hat")
...
for(i in seq_along(x_a_grid)) {
  ...
  results_matrix_non[row_counter, ] <- c(M_ba, t, x_a_init, x_a, e_hat_values$e_hat_a, x_b_init, x_b, e_hat_values$e_hat_b, NPV_a_hat, NPV_b_hat)
...
colnames(results_matrix_so) <- c("M_ba", "timestep", "x_a_init", "x_a", "e_star_a", "x_b_init", "x_b", "e_star_b", "NPV_a_star", "NPV_b_star")
...
for(i in seq_along(x_a_grid)) {
  ...
  # Save results including e_hat_a and e_hat_b
  results_matrix_so[row_counter, ] <- c(M_ba, t, x_a_init, x_a, e_star_values$e_star_a, x_b_init, x_b, e_star_values$e_star_b, NPV_a_star, NPV_b_star)
  row_counter <- row_counter + 1
...
colnames(results_matrix_soa) <- c("M_ba", "timestep", "x_a_init", "x_a", "e_a_star", "x_b_init", "x_b", "NPV_ea_star", "NPV_eb_star")
...
for(i in seq_along(x_a_grid)) {
  ...
  # Save results
  results_matrix_soa[row_counter, ] <- c(M_ba, t, x_a_init, x_a, e_a_star, x_b_init, x_b, NPV_ea_star, NPV_eb_star)
  row_counter <- row_counter + 1
...
write.csv(results, here("data","outputs","high_high","theta_Mba.csv"), row.names=FALSE)
