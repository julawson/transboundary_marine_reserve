...
low_low_orig <- read.csv(here("data","outputs","low_low","low_low_original.csv")) %>% add_column(scenario = "low_low")
low_high_orig <- read.csv(here("data","outputs","low_high","low_high_original.csv")) %>% add_column(scenario = "low_high")
high_low_orig <- read.csv(here("data","outputs","high_low","high_low_original.csv")) %>% add_column(scenario = "high_low")
high_high_orig <- read.csv(here("data","outputs","high_high","high_high_original.csv")) %>% add_column(scenario = "high_high")
...
ggsave(here("visuals","output","bar_plot_original.jpg"), bar_plot_original, width = 8, height = 6)
...
#ggsave(here("visuals","output","params_summary_ordered.jpg"), combined_plot, width = 15, height = 9)
...
ggsave(here("visuals","output","coop_to_res_summary.jpg"), coop_to_res, width = 15, height = 5)
